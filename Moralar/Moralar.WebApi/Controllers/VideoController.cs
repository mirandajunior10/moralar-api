...
namespace Moralar.WebApi.Controllers
{
    ...
    public class VideoController : Controller
    {
        ...
        public VideoController(IVideoRepository videoRepository, IHttpContextAccessor httpContextAccessor, IMapper mapper)
        {
        ...
        public async Task<IActionResult> LoadData([FromForm] DtParameters model)
        {
            ...
            try
            {
                ...
                response.Data = _mapper.Map<List<VideoViewModel>>(retorno);
